const globalStyles = {
    ...
    orderedListClasses: "list-decimal pl-4 md:list-inside space-y-2 md:space-y-0",
    connectClasses: "text-sm font-bold bg-gray-100 dark:bg-gray-950 hover:text-cyan-600 hover:dark:text-cyan-500 px-3 py-2 rounded-full flex items-center",
    connectIconClasses: "text-lg inline-block align-middle mr-1.5",
};
