...
const Footer = () => {
    return (
        <footer
          className="bg-gray-100 dark:bg-gray-950 border-t border-gray-100 dark:border-gray-950 py-6 px-4 md:px-8 text-sm text-center text-gray-600 dark:text-gray-400 font-semibold">
