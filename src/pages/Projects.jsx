    ...
    return (
        <main className="max-w-3xl mx-auto px-4 md:px-8 py-12 space-y-6 text-gray-700">
            ...
            <div className="space-y-6">
                <section>
                    <h2 className="text-lg font-bold text-gray-900 mb-1">Sandhills Development</h2>
                ...
                <section>
                    <h2 className="text-lg font-bold text-gray-900 mb-1">Client & Freelance Work (2012–2021)</h2>
                ...
                <section>
                    <h2 className="text-lg font-bold text-gray-900 mb-1">Loopdash</h2>
                    <p>
                ...
                <section>
                    <h2 className="text-lg font-bold text-gray-900 mb-1">Cordial</h2>
                    <p>
                ...
                <section>
                    <h2 className="text-lg font-bold text-gray-900 mb-1">STL|Hack</h2>
                    <p>
                ...
                <section>
                    <h2 className="text-lg font-bold text-gray-900 mb-3">Experiments</h2>
                    <ul className="list-item list-inside">
                        <li className="mb-2"><strong className="">LitePage Studio:</strong> A now-retired microsite experiment focused on ultra-fast HTML/CSS pages.</li>
                        <li className="mb-2"><strong className="">Top One Code:</strong> My freelance identity for a short time, phased out to simplify and consolidate.</li>
                        <li className="mb-2"><strong className="">This site:</strong> A personal platform, built in React + Vite. It’ll continue to evolve over time.</li>
                    </ul>
                </section>
            </div>
        </main>
